...
class CheckpointManager:
    ...
    def checkpoint(self, universe: Universe) -> Optional[Path]:
        """
    ...
    def restore_latest(self, universe_id: str) -> Optional[Universe]:
        """
