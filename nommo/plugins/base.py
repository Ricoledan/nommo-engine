...
class ForceFieldPlugin(Plugin):
    ...
    def calculate_forces(
        ...
        types: np.ndarray,
        box_size: np.ndarray,
        neighbor_list: list[tuple[int, int]] | None = None,
...
class AnalysisPlugin(Plugin):
    ...
    @abstractmethod
    def analyze(self, universe: Any, history: list[Any] | None = None) -> dict[str, Any]:
        """
    ...
    def update(self, universe: Any) -> dict[str, Any] | None:
...
class VisualizationPlugin(Plugin):
    ...
    def create_animation(self, trajectory: list[np.ndarray], **kwargs) -> Any:
...
class ExportPlugin(Plugin):
    ...
    @abstractmethod
    def export(self, data: dict[str, Any], output_path: Path, **kwargs) -> None:
        """
        Export data to file.
    ...
    @abstractmethod
    def import_data(self, input_path: Path, **kwargs) -> dict[str, Any]:
        """
...
class ReactionPlugin(Plugin):
    ...
    @abstractmethod
    def can_react(
        self, particle1: Any, particle2: Any, distance: float, temperature: float
    ) -> bool:
        """
    ...
    @abstractmethod
    def apply_reaction(self, particle1: Any, particle2: Any, universe: Any) -> list[Any]:
        """
...
class PluginRegistry:
    ...
    def get_force_field(self, name: str) -> ForceFieldPlugin | None:
    ...
    def get_visualizer(self, name: str) -> VisualizationPlugin | None:
        """Get visualization plugin."""
        return self._visualizers.get(name)

    def get_exporter(self, name: str) -> ExportPlugin | None:
        """Get export plugin."""
        return self._exporters.get(name)

    def get_reaction(self, name: str) -> ReactionPlugin | None:
        """Get reaction plugin."""
